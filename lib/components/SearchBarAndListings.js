...
class SearchBarAndListings extends React.Component {
  ...
  sendLocationRequest() {
    ...
    $.getJSON("https://lookingforme.herokuapp.com/api/v1/recent_jobs?location=" + search_location,
      (response) => {
    ...
    return (
      <div>
        <div className="search-bar">
          <FormGroup>
            <FormControl type="text" placeholder="Search jobs by location" className="search-bar-input" onChange={this.handleInputChange.bind(this)}/>
          </FormGroup>
