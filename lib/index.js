...
class JobShow extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      //   <a target="_blank" href={this.state.job.url}>View job posting</a>
      //   <p>Location: {this.state.job.location}</p>
      //   <p>Date posted: {this.state.job.posted_date}</p>
      //   <p>Remote? {this.state.job.remote ? 'Yes' : 'No'}</p>
      //   <div>Technologies:
      //     <ul>
      //       {this.state.job.raw_technologies.map((technology) => {
